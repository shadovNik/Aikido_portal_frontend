...
function ClubDeleteModal({ closeModal, onDeleteClick }) {
  return (
    <>
      <div className="creator__modal">
        <div className="delete__content">
          ...
          <p className="delete__message">Клуб <span className='delete__message-bold'>Прайм</span> будет удален навсегда. Вы точно хотите его удалить?</p>
